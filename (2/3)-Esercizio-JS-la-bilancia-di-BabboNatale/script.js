...
let scelta = prompt(
  "Cosa vuoi calcolare? (peso medio / peso massimo / peso minimo / numero di giocattoli)"
);
...
if (scelta === "peso medio") {
  ...
  console.log(
    "Operazione non riuscita. Verifica di avere posato correttamente il giocattolo:"
  );
